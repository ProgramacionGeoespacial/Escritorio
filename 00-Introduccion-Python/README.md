...
Python se caracteriza por ser un lenguaje cuyos programas son fáciles de leer y emplean menos líneas de código que otros lenguajes de programación. Es un lenguaje multiplataforma que puede ejecutarse en los sistemas operativos más utilizados (ej. Microsoft Windows, macOS, Linux, Android). Es un [lenguaje interprestado](https://es.wikipedia.org/wiki/Int%C3%A9rprete_(inform%C3%A1tica)) que ofrece un [sistema de tipos de datos dinámicos](https://es.wikipedia.org/wiki/Tipado_din%C3%A1mico) y [administración automática de memoria](https://es.wikipedia.org/wiki/Gesti%C3%B3n_de_memoria).
